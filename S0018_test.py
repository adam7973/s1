...
print("Schools (and this includes all educational activities) influence the")
print("future of society through what they teach.")
print("They should teach exclusively free software,")
print("so as to use their influence for the good.")
print("To teach a proprietary program is to implant dependence,")
print("which goes against the mission of education.")
print("By training in use of free software, schools will direct society's")
print("future towards freedom, and help talented programmers master the craft")
print("Learn more: gnu.org/philosophy/free-software-even-more-important.html")
